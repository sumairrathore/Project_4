function getLeagueInfo() {
    ...
    $.get("/league_info", { table: selectedTable, selectedPlayer: selectedPlayer }, function(data) {
...
$(document).ready(function() {
    ...
    $(".filters a").click(function(event) {
        ...
        // Call the getLeagueInfo function to update the table data
        getLeagueInfo();
    });
    // Fetch table data for the initial table
    var initialTable = $(".filters a:first").attr("href").substring(1);
    fetchTableData(initialTable);
    // Call the getLeagueInfo function initially to load the default table data
    getLeagueInfo();
});
